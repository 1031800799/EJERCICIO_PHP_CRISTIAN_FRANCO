...
<html>
  ...
  <?php
  echo "Cristian Franco";
?>
  <?php
  echo "<br>Quieres algo entonces ven y haz que pase recuerda que nuestros servicios siempre estaran a tu disposicion !";
  ?>
  <?php
  echo "<br>A";
  echo "<br>B";
  echo "<br>C";
   ...
   <?php
   echo "<br>","<strong>Utilizamos las mejores marcas y modelos que garanticen una alta disponibilidad y satisfagan los requerimientos, todos nuestros proyectos son implementados con materiales de calidad, bajo el respaldo de fabricantes reconocido.</strong>";
?>
<?php
...
?>
<?php
define("NeoTec", "Buenas tardes soy el ingeniero representante de la empresa NeoTec!", false);
echo "<br>",NeoTec;
...
<?php
require 'config.php';
echo '<img src="'.$image_path.'avianca.jpeg" >';
?>
